...
```{r setup}
knitr::opts_knit$set(root.dir = "D:/Davenport/Data 710 Scripts/Data")
```
...
![Source: https://upload.wikimedia.org/wikipedia/commons/d/da/Binary_search_tree.svg](Data/Binary Search Tree.JPG)
...
![Source: Bus Terminal Simulation Graphic](Data/Bus Simulation.JPG)
