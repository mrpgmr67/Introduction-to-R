...
4. Build a farming simulation based on the combination of both workers and crops.  Calculate yearly projections. Create input variables for each of the components, and run the simulation for a five year cycle.
